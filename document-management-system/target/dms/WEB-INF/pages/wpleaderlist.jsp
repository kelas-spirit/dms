...
<table style="width: 100%; font-size: 12px;" border="0" id="searchTbl">
	...
	<c:forEach items="${fold}" var="fold" varStatus="status">
   ...
   <td width="100">
    <a href="javascript:deleteRole('<s:url value="/dffwpl"/>?id=${fold.folderId }');">
...
<br>
  ...
  <s:url value="/setwpleadere" var="setwpleadere" />
  <form method="post" action="${setwpleadere}" >
  Set new folder id: <br><input type="text" class="textfield" value="" id="extra7" name="folderId" onkeypress="return isNumber(event)" />
 <input type="hidden" value="${userId}" name="userId" /> 
  <input type="hidden" value="${username}" name="username" /> 
  <input type="hidden" value="ROLE_WORKPACKAGE_LEADER" name="authority" /> 
