...
<br>
     <br>
    <form name='fold_as_link' method="post" action="/dms/settaskpr" style="position:absolute; right:30%;top:25%;">
    <input type="hidden" value="${folderId}" name="folderId" /> 
	New user: <br>
    <input type="text" name="username" placeholder="Type username..." style="width: 200px; height: 28px;">
     <button style=" background-color:#3366FF ;
background-repeat:no-repeat; width:100px; height:27px;outline: 0;
  padding:0; border:none;color:white;" name="submit">Send</button> 
    </form>
