...
insert into `dms`.USERS(user_id, ENABLED, USERNAME, PASSWORD) values(1,1,'admin','admin');
insert into `dms`.USERS(user_id, ENABLED, USERNAME, PASSWORD) values(2,1,'kelas','741f6931a7deef0883128cb407b31e166432498a');
